        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayGainChange = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePercentChange = table.Column<string>(nullable: true),
                    Shares = table.Column<string>(nullable: true),
                    CostBasis = table.Column<string>(nullable: true),
                    MarketValue = table.Column<string>(nullable: true),
                    DayGainChange = table.Column<string>(nullable: true),
                    DayGainPercentChange = table.Column<string>(nullable: true),
                    TotalGainChange = table.Column<string>(nullable: true),
                    TotalGainPercentChange = table.Column<string>(nullable: true),
                    NumOfLots = table.Column<string>(nullable: true),
                    Notes = table.Column<string>(nullable: true),
                    Date = table.Column<DateTime>(nullable: false),
                    SnapshotInfoId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
